...
print('Elements from 0th Index to 4th Index:',
      myList[0: 5])  # Prints elements of the list from 0th index to 4th index. IT DOESN'T INCLUDE THE LAST INDEX
...
# To pop last element
print('Poped Element is:', myList.pop())

# To remove a particular element from the list BY NAME
myList.remove(6)
print('After removing \'6\' List is:', myList)
